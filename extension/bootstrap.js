...
var PersonasPlusBootstrapAddon = {
	...
	startup:function(data,reason){
		...
		if(reason == ADDON_ENABLE){
			...
			try { LightweightThemeManager.currentTheme=JSON.parse(PersonasPlusBootstrapAddon.prefsinstance.getCharPref("extensions.personas.lastselected0")); }
			catch (e) { }
		}		
	},
	...
	setDefaultLocalizations:function(){
		...
		this.STRINGS["personas.properties"]=Components.classes["@mozilla.org/intl/stringbundle;1"].getService(Components.interfaces.nsIStringBundleService).createBundle("chrome://personas/locale/personas.properties");
		this.STRINGS["personas_bootstrap.properties"]=Components.classes["@mozilla.org/intl/stringbundle;1"].getService(Components.interfaces.nsIStringBundleService).createBundle("chrome://personas/locale/personas_bootstrap.properties");
	},
...
function uninstall(data,reason){
	...
	Components.classes["@mozilla.org/preferences-service;1"].getService(Components.interfaces.nsIPrefService).getBranch("extensions.personas.").deleteBranch("");
	Components.classes["@mozilla.org/intl/stringbundle;1"].getService(Components.interfaces.nsIStringBundleService).flushBundles();
